...
Helpers.prototype.products = function (filters) {
  if (filters) this.query = this.uriFilters(filters)
 ...
 * @return {[type]} [description]
 */
Helpers.prototype.productTypes = function (filters) {
  if (filters) this.query = this.uriFilters(filters)
...
Helpers.prototype.uriFilters = function (filters) {
  return qs.stringify(filters)
}

module.exports = function (domain) {
  return new Helpers(domain)
}
